...
export const SaveUnitModal: React.FC<SaveUnitModalProps> = ({ isOpen, onClose, onSave, initialData, unitTitle }) => {
    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4" onClick={onClose}>
      <div className="bg-gray-900 border border-gray-700 rounded-lg shadow-xl w-full max-w-lg" onClick={e => e.stopPropagation()}>
        <div className="flex items-center justify-between p-4 border-b border-gray-800">
          <h2 className="text-lg font-semibold text-gray-100">Guardar Unidad Didáctica</h2>
        ...
        <div className="p-6 space-y-4">
          <p className="text-sm text-gray-400">Complete los datos para asociar a esta unidad didáctica. Esta información es necesaria cuando se generan unidades desde texto.</p>
          <div className="p-4 bg-gray-800 rounded-md border border-gray-700">
            <p className="font-semibold text-gray-200">{unitTitle}</p>
          </div>
          <div>
