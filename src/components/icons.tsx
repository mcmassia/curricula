...
export const WandSparklesIcon: React.FC<IconProps> = ({ className }) => (
    <svg 
        ...
        strokeLinejoin="round"
    >
        <path d="m22 2-7 20-4-9-9-4Z"/><path d="M13 2 3 14"/>
    </svg>
);
...
export const PaperAirplaneIcon: React.FC<IconProps> = ({ className }) => (
    <svg
        ...
        strokeLinejoin="round"
    >
        <path d="M2 21l21-9L2 3v7l9 2-9 2v7z" />
    </svg>
);
...
export const FolderKanbanIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const FileJsonIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M10 12h1"/>
        <path d="M13 18h1"/>
        <path d="M10 15a1 1 0 0 0 1 1h1a1 1 0 0 0 1-1v-2a1 1 0 0 0-1-1h-1a1 1 0 0 1-1-1V9a1 1 0 0 1 1-1h1a1 1 0 0 1 1 1"/>
    </svg>
);
...
export const GoogleIcon: React.FC<IconProps> = ({ className }) => (
    ...
    >
        ...
        <path fill="#FBBC05" d="M10.53 27.58A14.4 14.4 0 0 1 9.82 24c0-1.43.21-2.82.6-4.14V13.7L2.56 7.58A24.01 24.01 0 0 0 0 24c0 4.54 1.25 8.74 3.41 12.42l7.12-5.84z"/>
        <path fill="#EA4335" d="M24 48c6.48 0 12.07-2.14 16.09-5.84l-7.73-6c-2.52 1.7-5.71 2.68-9.36 2.68-6.26 0-11.57-4.22-13.47-9.91l-7.98 6.19C6.51 42.62 14.62 48 24 48z"/>
